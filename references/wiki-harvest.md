...
3. **wiki 후보 추출** (미처리 파일 Read 후): 볼드 용어(`**Term**`), dangling `[[링크]]`, H2/H3 개념 제목을 모읍니다. 기존 `wiki-term: true` 노트와 중복이면 제외해요. dangling 링크의 텍스트가 기존 노트의 H1이나 aliases와 같으면 새 용어가 아니라 제목형 링크이니 후보에서 뺍니다(#8607 D6).
