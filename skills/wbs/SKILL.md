...
name: wbs
description: >
  서비스 개발 WBS를 상태 머신 기반으로 생성·관리 — Phase 구성, 진행 현황 업데이트, Excel 변환 안내. "WBS 만들어줘", "Phase 추가", "wbs" 요청 시 사용.
  Do NOT use for .base 대시보드·현황 뷰 → sr-obsidian:obsidian-bases.
  Do NOT use for 프로젝트 허브 노트·KPI → sr-obsidian:hub.
