...
name: hub
description: >
  프로젝트 허브 노트({project-id} 프로젝트 현황.md) 생성·링크·KPI·상태 관리. "허브 업데이트", "현황 노트", "프로젝트 현황 정리" 요청 시 사용.
  Do NOT use for 신규 프로젝트 폴더 생성 → sr-obsidian:scaffold.
  Do NOT use for ISS 인시던트 구조 → sr-obsidian:iss.
  Do NOT use for WBS Phase·step 상태머신 → sr-obsidian:wbs.
  Do NOT use for 인수인계·경위 문서 → sr-obsidian:handover.
